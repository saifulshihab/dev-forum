                  ...
                  skillsField.fields.map((field, fieldIdx) => (
                    <div key={field.id} className="group col-span-1 flex">
                      ...
                      <Button
                        ...
                        variant="ghost"
                        className="-translate-x-1 transform opacity-0 transition hover:bg-transparent active:scale-95 group-hover:translate-x-1 group-hover:opacity-100"
                        size="icon"
                      >
                        <X />
                      </Button>
              ...
              <div className="flex w-full flex-col gap-2">
                ...
                <div className="flex flex-col gap-5">
                  {projectField.fields.length ? (
                    ...
                    <p className="text-xs text-zinc-400">No projects added</p>
                  )}
                </div>
              </div>
              <Button
              ...
              <div className="flex w-full flex-col gap-2">
                ...
                <div className="flex flex-col gap-5">
                  {educationField.fields.length ? (
                    ...
                    <p className="text-xs text-zinc-400">No educations added</p>
                  )}
                </div>
              </div>
              <Button
                      ...
                      >
                        <div className="flex items-center justify-between gap-3">
                          ...
                          <Button
                            size="icon"
                            variant="destructive"
                            onClick={() => socialLinksField.remove(fieldIdx)}
                          >
                            <Trash />
                          </Button>
                        </div>
